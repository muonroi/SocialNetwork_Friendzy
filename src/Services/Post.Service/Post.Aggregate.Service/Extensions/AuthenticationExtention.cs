...
public static class AuthenticationExtention
{
        ...
        this IApplicationBuilder app, IConfiguration configuration)
    {
        _ = app.UseJwtMiddleware(async (serviceProvider, context) =>
        {
            ...
            AuthenticateVerifyClient userClient = grpcClientFactory.CreateClient<AuthenticateVerifyClient>(ServiceConstants.AuthenticateService);
            VerifyTokenReply validateToken = await userClient.VerifyTokenAsync(new VerifyTokenRequest
            {
